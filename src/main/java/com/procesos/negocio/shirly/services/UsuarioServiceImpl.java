...
public class UsuarioServiceImpl implements UsuarioService {
    ...
    @Override
    public ResponseEntity<List<Usuario>> allUserByNameAndLastName(String nombre, String apellidos) {
    ...
    @Override
    public ResponseEntity<List<Usuario>> allUserByName(String nombre) {
    ...
    @Override
    public ResponseEntity<List<Usuario>> allUserByLastName(String apellidos) {
    ...
    @Override
    public ResponseEntity<Usuario> editarUser(Long id, Usuario usuario) {
